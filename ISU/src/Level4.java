...
public class Level4 extends AbstractLevel {
    public Level4() {
        ...
        Tank computerTank1 = new RandomComputerTank("ISU/Resources/EnemyTank2.png");
        computerTank1.setIsPlayer(false);
        computerTank1.setCenterOfTank(600, 265);
        computerTank1.setSpeed(3);
        Tank computerTank2 = new RandomComputerTank("ISU/Resources/EnemyTank2.png");
        computerTank2.setIsPlayer(false);
        computerTank2.setCenterOfTank(350, 265);
        computerTank2.setSpeed(3);
        Tank computerTank3 = new FollowPlayerComputerTank("ISU/Resources/EnemyTank2.png");
        ...
        Tank computerTank5 = new RandomComputerTank("ISU/Resources/EnemyTank2.png");
        computerTank5.setIsPlayer(false);
        computerTank5.setCenterOfTank(500, 355);
        computerTank5.setSpeed(4);
        Tank computerTank6 = new RandomComputerTank("ISU/Resources/EnemyTank2.png");
