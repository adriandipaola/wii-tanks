/**
 * The second of two computer tank methods: this tank goes into a random direction for a random amount of time.
 */
...
public class RandomComputerTank extends Tank {
    ...
    public void move(Tank otherTank) {
        //determining which direction it will move
        ...
        if (duration > 0) {
            ...
            //figuring out how long the tank will move in the same direciton for
